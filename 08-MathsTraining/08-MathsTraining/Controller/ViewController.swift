...
//  08-MathsTraining
//
//  Created by Carlos Daniel Pedrerol on 26/10/2020.
//
...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var mnistModel: ImageClassificationModel = try! ImageClassificationModel(configuration: MLModelConfiguration())
...
//        1- Redimensionar la imagen del usuario a una de 299 x 299 (Tamaño que espera el modelo)
...
//        5- Al detectar la imagen debemos saber el número que ha escrito el usuario y validar la respuesta
            ...
            DispatchQueue.main.async {
                // El resultado es la etiqueta donde el modelo ha catalogado nuestra imagen
...
//        6- Unir todo en un VNImageRequestHandler
